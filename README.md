...
python3 scripts/apply_oman_fixes.py   # إصلاح المسارات، إخفاء زر الاتصال، واتساب إماراتي فقط
```
...
- خريطة الموقع تتضمن صفحات الخدمات `/services/{slug}/` وأرشيف المدن والتصنيفات
- نشر المسودات: `python3 scripts/publish_schedule_oman.py` ثم `--resume` إذا انقطع الجدول
