...
<ul>
<li>واتساب: <a href="{wa}" rel="noopener">+{WHATSAPP}</a></li>
...
<h3>كيف أطلب؟</h3>
<p>واتساب على الرقم الظاهر في الموقع، ونحدد موعد المعاينة.</p>
<h3>هل يوجد ضمان؟</h3>
...
"""
    return {
        ...
        "contact": {
            "title": "اتصل بنا",
            "excerpt": "تواصل مع ركن التطور عُمان عبر واتساب لتحديد معاينة في مدينتك.",
            "html": contact.strip(),
            "en_title": "Contact Rukn Eltatawer Oman",
            "en_html": f"<section><h2>WhatsApp us in Oman</h2><p><a href='{wa}'>WhatsApp {WHATSAPP}</a>. We cover Muscat, Salalah, Nizwa, Sohar, Sur, Al Buraimi, Ibri and Rustaq. No phone-call button on the site.</p></section>",
        },
        "our-services": {
            "title": "خدماتنا",
...
def upsert_snippet(wp: WP, code_php: str) -> None:
    ...
    payload = {
        ...
        "desc": "Post taxonomies, city/category archives, main menu location. Service CPT URLs stay live.",
        "code": code_php,
        "scope": "global",
        "active": True,
        "priority": 8,
